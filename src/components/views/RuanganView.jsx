                              ...
                              currentRoomData.items?.filter(it => !it.isLocalOnly).map((it, i) => {
                                 ...
                                 <tr key={i} className={isDarkMode ? 'hover:bg-slate-700/50' : 'hover:bg-slate-50'}>
                                    ...
                                    <td className="py-4 text-center flex justify-center gap-1 md:gap-2">
                                        <button onClick={() => handleExportBulkLabel([mergedItem], selectedRoomName)} className="p-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:text-slate-300 rounded-lg transition-colors" title="Cetak Label"><QrCode size={14}/></button>
